...
Scope {
    ...
    Variants {
        ...
        Scope {
            ...
            property var monitor: Compositor.monitorFor(modelData)

            // Hide when fullscreen
            property var workspacesForMonitor: Compositor.workspaces.values.filter(workspace => workspace.monitor && workspace.monitor.name == monitor?.name)
